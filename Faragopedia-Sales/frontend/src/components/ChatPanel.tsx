...
const ChatPanel: React.FC<Props> = ({ className = '', onLinkClick, showHeader = true }) => {
  ...
  return (
    <div className={`flex flex-col bg-white dark:bg-gray-900 h-full ${className}`}>
      {showHeader && (
        <div className="border-b dark:border-gray-800 px-4 h-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm z-10 flex items-center justify-between shrink-0">
      ...
      <div className="flex-grow overflow-y-auto p-4 space-y-4">
        {chatHistory.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-gray-400 dark:text-gray-600 space-y-4 text-center">
        ...
        {chatLoading && (
          <div className="flex justify-start">
            <div className="bg-gray-100 dark:bg-gray-800 px-5 py-3 rounded-2xl rounded-tl-none flex items-center space-x-2">
      ...
      <div className="p-3 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700 shrink-0">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 pr-10 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
          />
          <button
            onClick={handleChat}
            disabled={chatLoading || !chatQuery.trim()}
            className="absolute right-1.5 top-1.5 bg-blue-600 text-white p-1.5 rounded-lg hover:bg-blue-700 transition-colors disabled:bg-gray-300 dark:disabled:bg-gray-700 disabled:cursor-not-allowed"
          >
